...
public class EnemyLv3Controller : MonoBehaviour
{
    ...
    private float currentHealth = 35;
    ...
    void Start()
    {
        ...
        {
            spawnPosition = new Vector3(bottomLeft.x, Random.Range(1.5f, 3f), 0f);
            lookRight = true;
        }
        else
        {
            spawnPosition = new Vector3(topRight.x, Random.Range(1.5f, 3f), 0f);
            lookRight = false;
        }
